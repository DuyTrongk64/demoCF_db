...
insert into receipt (receipt_id, sale, tbl_id, datetime, sum)
values ('b1793079',default,'b1','12-4-2019 08:23:30',125000),
       ('b3949270',default,'b3','12-4-2019 08:27:30',150000),
       ('b4417335',default,'b4','12-4-2019 22:13:39',225000),
       ('b7786762',20,'b7','13-4-2019 09:30:15',125000),
       ('b1149772',10,'b11','13-4-2019 18:25:30',75000),
       ('b6618156',default,'b6','13-4-2019 21:15:29',175000),
       ('b4473067',15,'b9','14-4-2019 08:30:30',100000),
       ('b1322864',default,'b12','12-4-2019 08:23:30',80000);

insert into receipt_infor( receipt_id, ma_mon, amount, "Salary")
values ('b1793079',)
